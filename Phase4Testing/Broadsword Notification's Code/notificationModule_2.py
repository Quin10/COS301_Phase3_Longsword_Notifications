...
try:
    ...
    requestServer = nsq.Reader(message_handler=NotificationRequest.sendEmail(), lookupd_http_addresses=['http://127.0.0.1:4161'], topic='Notification', channel='NavUP', lookupd_poll_interval=15)
    nsq.run()
except:
